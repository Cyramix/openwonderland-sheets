...
public class GenericSheetGuideView extends JPanel
    ...
    public void initialize(ISocialManager manager, Sheet sheet, Role role) {
        ...
        /**
         * Check if the sheet is singleton (Unit goal sheet). If yes, find the
         * previously submitted goal results and display them.
         */
    ...
    /**
     * This method add the initial column headings. The headings includes the
     * question titles. The answer rows for each student are added later on.
     */
    ...
    /**
     * The table renderer of JTextArea is added to table cells to display the
     * cell text wrapped.
     */
