 ...
 *
 * Created on Jun 10, 2011, 11:34:14 AM
 */
...
public class StudentDetailsPanel extends javax.swing.JPanel {
    ...
    private int pass;
    private int strike;
    private final int tokenMaxLimit = 10;
    ...
    StudentDetailsPanel(ISocialManager manager, Student student) {
        initComponents();
    ...
    private void tokenIncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tokenIncActionPerformed
    ...
    }//GEN-LAST:event_tokenIncActionPerformed

    private void passIncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passIncActionPerformed
        firePropertyChange(student.getName(), null, "");
        ...
        passes.setText(String.valueOf(pass));
        firePropertyChange(student.getName(), null, "");
    }//GEN-LAST:event_passIncActionPerformed

    private void strikeIncActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_strikeIncActionPerformed
        firePropertyChange(student.getName(), null, "");
        ...
        firePropertyChange(student.getName(), null, "");
    }//GEN-LAST:event_strikeIncActionPerformed

    private void tokenDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tokenDecActionPerformed
        firePropertyChange(student.getName(), null, "");
        if (token == 0) {
            return;
        }
        ...
        tokens.setText(String.valueOf(token) + "/10");
        firePropertyChange(student.getName(), null, "");
    }//GEN-LAST:event_tokenDecActionPerformed

    private void passDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_passDecActionPerformed
        firePropertyChange(student.getName(), null, "");
        if (pass == 0) {
            return;
        }
        ...
        passes.setText(String.valueOf(pass));
        firePropertyChange(student.getName(), null, "");
    }//GEN-LAST:event_passDecActionPerformed

    private void strikeDecActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_strikeDecActionPerformed
        firePropertyChange(student.getName(), null, "");
        if (strike == 0) {
            return;
        }
        ...
        strikes.setText(strikeValues[strike]);
        firePropertyChange(student.getName(), null, "");
    }//GEN-LAST:event_strikeDecActionPerformed
